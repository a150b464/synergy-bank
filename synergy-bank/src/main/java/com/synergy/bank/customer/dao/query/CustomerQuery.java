...
public interface CustomerQuery {
 ...
 public static final String FIND_CUTOMER 				= "select * from customer_details_tbl where userid";
 public static final String SHOW_PAYEE_LIST				= "select * from payee_information_tbl where userid=";
 public static final String ADD_PAYEE					= "insert into payee_information_tbl(userid,payeeAccountNo,payeeName,payeeNickName,mobile,doe,email,status) values(?,?,?,?,?,?,?,'pending')";
 public static final String FIND_PAYEE					= "select * from payee_information_tbl where userid =";
