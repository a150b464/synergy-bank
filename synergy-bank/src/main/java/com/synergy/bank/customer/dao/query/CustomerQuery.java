...
public interface CustomerQuery {
	...
	public static final String INSERT_CREDITFORM = "insert into credit_details_tbl(userId,occupation,salutation,gender,firstName,middleName,lastName,maritalStatus,dob,category,motherMaidenName,fatherName,email,mobile,ssn,company,education,grossAnualIncome,sourceOfFunds,photo) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
