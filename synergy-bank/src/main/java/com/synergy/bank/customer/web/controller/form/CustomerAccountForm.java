...
public class CustomerAccountForm {
	...
	public String toString() {
		return "CustomerAccountForm [ userid=" + userid + ", customerName="
				+ customerName + ", customerAccountNo=" + customerAccountNo
				+ ", accountType=" + accountType + ", availBalance="
				+ availBalance + ", totalAvailBalance=" + totalAvailBalance
				+ ", currency=" + currency + ", doe=" + doe + ", dom=" + dom
				+ "]";
	}
}
