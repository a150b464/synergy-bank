...
<body>
	...
	<div id="content">
		...
		<ff:form action="resetPassword" method="post" >
			<table align="center" width="70%" border="1" cellspacing="1" cellpadding="3">
				<tr>
					<td>old password:</td><input type="text" name="oldPassword"></td>
				<tr>
					<td>new password:</td><input type="text" name="newPassword"></td>
				</tr>
				<tr>
					<td>confirm new password:</td><input type="text" name="newPasswordConfirm"></td>
				</tr>
