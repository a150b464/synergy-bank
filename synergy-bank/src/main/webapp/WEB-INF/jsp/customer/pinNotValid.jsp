...
<body onload="javascript:breadcrumbs()">
	...
	<div id="header">
		...
		<img src="${pageContext.request.contextPath}/images/security.jpg" width="892" height="230" />
	</div>
	
	<div id="content">
			<h1 style="color: red"> Verification Pin Not Valid. Please Contact the Customer Service to generate a new Verification Pin.</h1> 
			<br/>
