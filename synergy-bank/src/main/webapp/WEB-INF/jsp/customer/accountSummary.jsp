...
<body>
	<%@include file="cheader.jsp"%>
		<h1 align="center"><img src="${pageContext.request.contextPath}/images/account.jpg" alt="" width="700" height="250" /></h1>
	<div id="content">
		<h1 align="center">Accounts Details</h1><br>
		...
		<h1 align="center">Accounts Summary</h1><br>
			<table align="center">
			<thead>
				<tr>
					<td>Total Deposit</td>
		...
		<ul id="menu">
			<li><h3 align="center"><a href="viewMiniStatement">View Mini Statement</a></h3></li>
		</ul>
